package arnnus.importationapi.config;
...
import static arnnus.importationapi.constant.Constant.X_REQUESTED_WITH;
...
public class CorsConfig {
    ...
    public CorsFilter corsFilter(){
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000")); //Port selon le type d'app 4200 souvent pour Angular
